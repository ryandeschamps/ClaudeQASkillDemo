...
3.  **Step 2: Extract and Number Requirements:**
...
4.  **Step 3: Extract Entities and Flows:**
...
5.  **Step 4: Derive Test Scenarios:**
...
6.  **Step 5: Define Variants:**
    ...
    - **Note:** Step 8 will optimize this set to select the minimal subset for pairwise coverage.

7.  **Step 6: Create Test Data:**
...
8.  **Step 7: Generate Test Scripts:**
...
9.  **Step 8: Produce Combinatorial Plan:**
...
11. **Step 10: Build Requirements Traceability Matrix (RTM):**
    - **Execute the `scripts/rtm_builder.py` script** using the command:
      ...
      python3 skill/scripts/rtm_builder.py deliverables/03_test_scenarios.md \
          deliverables/00_requirements.md --test-scripts deliverables/06_test_scripts \
          --gap-report
      ```
...
12. **Completion:** Notify the user that all QA artifacts have been generated and are available in the `deliverables/` directory.